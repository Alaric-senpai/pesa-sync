      ...
      <ScrollableContainer>
        ...
        <View className="px-5 pt-12">
          <View className="flex-row justify-between items-center mb-6">
            <TouchableOpacity 
              onPress={() => router.back()} 
              className="justify-center items-center bg-white shadow-sm rounded-full w-12 h-12"
            >
          ...
          <View className="bg-white shadow-md rounded-2xl overflow-hidden">
            <View className="p-6">
              ...
              <View className=" rounded-2xl">
                <View className="mb-4">
                  <Text className="font-medium text-gray-600 mb-2">Net Balance (Outstanding)</Text>
                  <Text className={`font-bold text-2xl ${netBalanceColor}`}>
                ...
                <View className="flex-col gap-2">
                  <View className="flex-1 pr-2">
                    <View className="flex-row items-center mb-1">
                      ...
                      <Text className="text-gray-600 text-sm">Owed to you</Text>
                    </View>
                    <Text className="ml-5 font-bold text-green-600 text-lg">
                      KSh. {totalOwedRemaining.toLocaleString()}
                    </Text>
                    <Text className="ml-5 text-gray-500 text-xs">
                      Principal: KSh. {totalPrincipalOwed.toLocaleString()} · Paid: KSh. {((totalPrincipalOwed - totalOwedRemaining)).toLocaleString()}
                    </Text>
                  </View>
                  ...
                  <View className="flex-1 pl-2">
                    <View className="flex-row items-center mb-1">
                      ...
                      <Text className="text-gray-600 text-sm">You owe</Text>
                    </View>
                    <Text className="ml-5 font-bold text-red-600 text-lg">
                      KSh. {totalOweRemaining.toLocaleString()}
                    </Text>
                    <Text className="ml-5 text-gray-500 text-xs">
                      Principal: KSh. {totalPrincipalOwe.toLocaleString()} · Paid: KSh. {((totalPrincipalOwe - totalOweRemaining)).toLocaleString()}
                    </Text>
                  </View>
                </View>

                <View className="pt-3 border-t border-gray-200">
                  <Text className="text-gray-500 text-xs">Total paid across all debts: <Text className="font-medium text-gray-800">KSh. {totalPaid.toLocaleString()}</Text></Text>
                </View>
              </View>
            </View>
          </View>
        ...
        <View className="px-5 pb-24">
          <View className="mb-4">
            ...
            <View className="h-px bg-gray-200 mt-2"></View>
          </View>
