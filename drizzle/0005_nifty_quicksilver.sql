CREATE TABLE `payments` (
	...
	`note` text,
	`createdAt` integer DEFAULT 1760185327,
	`updatedAt` integer DEFAULT 1760185327
);
...
CREATE TABLE `__new_accounts` (
	...
	`debted_amount` integer DEFAULT 0,
	`created_at` integer DEFAULT 1760185327,
	`updated_at` integer DEFAULT 1760185327
);
--> statement-breakpoint
INSERT INTO `__new_accounts`("id", "name", "type", "currency", "user_id", "debt_amount", "income_amount", "debted_amount", "created_at", "updated_at") SELECT "id", "name", "type", "currency", "user_id", "debt_amount", "income_amount", "debted_amount", "created_at", "updated_at" FROM `accounts`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_debts`("id", "contact_id", "amount", "paid", "direction", "reason", "due_date", "settled", "createdAt", "updatedAt") SELECT "id", "contact_id", "amount", "paid", "direction", "reason", "due_date", "settled", "createdAt", "updatedAt" FROM `debts`;--> statement-breakpoint
